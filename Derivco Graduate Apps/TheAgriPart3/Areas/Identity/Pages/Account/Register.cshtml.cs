...
namespace TheAgriPart3.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        private readonly SignInManager<Farmer> _signInManager;
        private readonly UserManager<Farmer> _userManager;
        private readonly IUserStore<Farmer> _userStore;
        private readonly IUserEmailStore<Farmer> _emailStore;
        ...
        private IUserEmailStore<Farmer> GetEmailStore()
        {
            ...
            return (IUserEmailStore<Farmer>)_userStore;
        }
    }
}
